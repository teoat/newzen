            ...
            <div className="w-80 border-r border-white/5 bg-slate-950/30 p-8 flex flex-col gap-8 shrink-0">
                <div className="space-y-4">
                    ...
                    <button
                        onClick={handleScan}
                        disabled={isScanning}
                        className="w-full py-4 bg-indigo-600 hover:bg-indigo-500 rounded-2xl text-white font-black text-[11px] uppercase tracking-widest shadow-lg shadow-indigo-900/40 transition-all flex items-center justify-center gap-3"
                    >
                ...
                <div className="p-6 rounded-2xl bg-slate-900/40 border border-white/5 space-y-4">
                    <h3 className="text-[11px] font-black text-slate-400 uppercase tracking-widest">Feed Telemetry</h3>
                    ...
                    <div className="w-full max-w-4xl p-10 animate-in zoom-in duration-500">
                         <div className="grid grid-cols-2 gap-10">
                             <div className="aspect-square bg-slate-900/80 rounded-[2.5rem] border border-white/10 relative overflow-hidden shadow-2xl">
                                 <div className="absolute top-6 left-6 px-3 py-1 bg-black/60 backdrop-blur rounded font-mono text-[11px] text-indigo-500 border border-indigo-500/30 font-bold">
                             ...
                             <div className="flex flex-col gap-6 justify-center">
                                 <div className={`px-4 py-2 w-fit rounded-xl text-[11px] font-black uppercase tracking-widest border flex items-center gap-2 ${
                                 ...
                                 <div className="space-y-6">
                                     <div>
                                         <div className="flex justify-between items-end mb-2">
                                             <span className="text-[11px] font-black text-slate-500 uppercase tracking-widest">Reported Progress</span>
                                     ...
                                     <div>
                                         <div className="flex justify-between items-end mb-2">
                                             <span className="text-[11px] font-black text-indigo-500 uppercase tracking-widest">Detected Change</span>
                                 ...
                                 <div className="p-6 bg-slate-900/50 border border-white/5 rounded-2xl">
                                     <h4 className="text-[11px] font-black text-slate-400 uppercase tracking-widest mb-2">Analyst Intelligence</h4>
